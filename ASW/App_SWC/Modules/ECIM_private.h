...
#ifndef RTW_HEADER_ECIM_private_h_
#define RTW_HEADER_ECIM_private_h_
#include "rtwtypes.h"
...
extern void ECIM_Delay_Init(DW_Delay_ECIM_T *localDW);
extern void ECIM_Delay(boolean_T rtu_Enable, uint16_T rtu_TimeThrld,
  B_Delay_ECIM_T *localB, DW_Delay_ECIM_T *localDW);
extern void ECIM_DiffValue(real32_T rtu_Signal1, real32_T rtu_Signal2,
  B_DiffValue_ECIM_T *localB);

#endif                                 /* RTW_HEADER_ECIM_private_h_ */
