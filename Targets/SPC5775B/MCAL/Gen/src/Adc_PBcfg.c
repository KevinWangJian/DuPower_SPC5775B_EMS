...
* significance and case sensitivity are supported for external identifiers
*/
#define ADC_AR_ERLEASE_MINOR_VERSION_PBCFG_C     0
/**
* @violates @ref Adc_PBcfg_c_REF_3 The compiler/linker shall be checked to ensure that 31 character
* significance and case sensitivity are supported for external identifiers
*/
...
/* Check if source file and Adc_Reg_eSys_Eqadc header file are of the same vendor */
    ...
    #error "Adc_PBcfg.c and Adc_Reg_eSys_Eqadc.h have different vendor ids"
#endif
...
/* Check if source file and Adc_Reg_eSys_Eqadc header file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Adc_PBcfg.c and Adc_Reg_eSys_Eqadc.h are different"
#endif
...
/* Check if source file and Adc_Reg_eSys_Eqadc header file are of the same Software version */
    ...
    #error "Software Version Numbers of Adc_PBcfg.c and Adc_Reg_eSys_Eqadc.h are different"
#endif
...
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group1_AssignmentPB_0_1[ADC_CFGSET1_GROUP_1_CHANNELS] =
{
    1U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group2_AssignmentPB_0_1[ADC_CFGSET1_GROUP_2_CHANNELS] =
{
    2U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group3_AssignmentPB_0_1[ADC_CFGSET1_GROUP_3_CHANNELS] =
{
    3U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group4_AssignmentPB_0_1[ADC_CFGSET1_GROUP_4_CHANNELS] =
{
    4U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group5_AssignmentPB_0_1[ADC_CFGSET1_GROUP_5_CHANNELS] =
{
    5U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group6_AssignmentPB_0_1[ADC_CFGSET1_GROUP_6_CHANNELS] =
{
    6U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group7_AssignmentPB_0_1[ADC_CFGSET1_GROUP_7_CHANNELS] =
{
    7U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group8_AssignmentPB_0_1[ADC_CFGSET1_GROUP_8_CHANNELS] =
{
    8U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group9_AssignmentPB_0_1[ADC_CFGSET1_GROUP_9_CHANNELS] =
{
    9U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group10_AssignmentPB_0_1[ADC_CFGSET1_GROUP_10_CHANNELS] =
{
    10U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group11_AssignmentPB_0_1[ADC_CFGSET1_GROUP_11_CHANNELS] =
{
    11U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group12_AssignmentPB_0_1[ADC_CFGSET1_GROUP_12_CHANNELS] =
{
    12U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group13_AssignmentPB_0_1[ADC_CFGSET1_GROUP_13_CHANNELS] =
{
    13U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group14_AssignmentPB_0_1[ADC_CFGSET1_GROUP_14_CHANNELS] =
{
    14U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group15_AssignmentPB_0_1[ADC_CFGSET1_GROUP_15_CHANNELS] =
{
    15U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group16_AssignmentPB_0_1[ADC_CFGSET1_GROUP_16_CHANNELS] =
{
    16U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group17_AssignmentPB_0_1[ADC_CFGSET1_GROUP_17_CHANNELS] =
{
    17U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group18_AssignmentPB_0_1[ADC_CFGSET1_GROUP_18_CHANNELS] =
{
    18U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group19_AssignmentPB_0_1[ADC_CFGSET1_GROUP_19_CHANNELS] =
{
    19U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group20_AssignmentPB_0_1[ADC_CFGSET1_GROUP_20_CHANNELS] =
{
    20U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group21_AssignmentPB_0_1[ADC_CFGSET1_GROUP_21_CHANNELS] =
{
    21U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group22_AssignmentPB_0_1[ADC_CFGSET1_GROUP_22_CHANNELS] =
{
    22U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group23_AssignmentPB_0_1[ADC_CFGSET1_GROUP_23_CHANNELS] =
{
    23U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group30_AssignmentPB_0_1[ADC_CFGSET1_GROUP_30_CHANNELS] =
{
    24U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group31_AssignmentPB_0_1[ADC_CFGSET1_GROUP_31_CHANNELS] =
{
    25U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group32_AssignmentPB_0_1[ADC_CFGSET1_GROUP_32_CHANNELS] =
{
    26U
};
/**
...
*
*/
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group24_AssignmentPB_2_1[ADC_CFGSET1_GROUP_24_CHANNELS] =
{
    4U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group25_AssignmentPB_2_1[ADC_CFGSET1_GROUP_25_CHANNELS] =
{
    1U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group26_AssignmentPB_2_1[ADC_CFGSET1_GROUP_26_CHANNELS] =
{
    2U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group27_AssignmentPB_2_1[ADC_CFGSET1_GROUP_27_CHANNELS] =
{
    3U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group28_AssignmentPB_2_1[ADC_CFGSET1_GROUP_28_CHANNELS] =
{
    4U
};
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group29_AssignmentPB_2_1[ADC_CFGSET1_GROUP_29_CHANNELS] =
{
    5U
};
/**
...
/**
* @brief          Definition of ADC hardware units Configuration 1.
*/
static CONST(Adc_Eqadc_HwUnitConfigurationType, ADC_CONST) Adc_HwUnitCfgPB_1[] =
{
...
*/
static CONST(Adc_Eqadc_ChannelConfigurationType, ADC_CONST) Adc_ChannelsCfgPB_0_1[] =
{
...
/**
* @brief          Definition of channels on ADC Hardware unit 2 - Configuration 1.
* @details        Array of conversion command messages
*/
static CONST(Adc_Eqadc_ChannelConfigurationType, ADC_CONST) Adc_ChannelsCfgPB_2_1[] =
{
...
*
*/
static P2CONST(Adc_Eqadc_ChannelConfigurationType, ADC_VAR, ADC_APPL_CONST) Adc_ChannelsCfgPB_1[] =
{
    Adc_ChannelsCfgPB_0_1,
    NULL_PTR,
    Adc_ChannelsCfgPB_2_1,
    NULL_PTR
};
...
*/
/** @violates @ref Adc_PBcfg_c_REF_4 MISRA-C:2004 Rule 8.10: External linkage.*/
