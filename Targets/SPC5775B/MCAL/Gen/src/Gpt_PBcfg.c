...
*/
extern void Callback_func(void);
/** @} */
...
static CONST(Gpt_ChannelConfigType, GPT_CONST) Gpt_InitChannelPB_0[1] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Callback_func, /* Channel notification */
        ...
        (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        {
            ...
            (boolean)FALSE, /* Freeze Diasble */

            (uint8)(0U), /* Not used for PIT */
        }
    }
...
CONST(Gpt_ConfigType, GPT_CONST) GptChannelConfigSet_0 =
{
    ...
    /*Hardware to logic channel mapping.*/
    {
        ...
        GptConf_GptChannelConfiguration_GptChannelConfiguration_0, /*mapping of PIT_0_CH_0*/
