...
/* @violates @ref fls_pbcfg_c_REF_6 Re-use of C90 identifier pattern */
...
CONST(Fls_ConfigType, FLS_CONST) FlsConfigSet_0 =
{
    ...
    /* @violates @ref fls_pbcfg_c_REF_7 A cast should not be performed between a pointer type and an integral type. */
