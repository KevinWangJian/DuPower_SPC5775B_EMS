...
*/
#define PWM_MAX_CHANNELS_U8  (10U)
...
*/
#define PwmChannel_FAN4_CONTROL         ((Pwm_ChannelType)0U)
#define PwmChannel_FAN3_CONTROL         ((Pwm_ChannelType)1U)
#define PwmChannel_FAN2_CONTROL         ((Pwm_ChannelType)2U)
#define PwmChannel_FAN1_CONTROL         ((Pwm_ChannelType)3U)
#define PwmChannel_LED2_PWM_EN         ((Pwm_ChannelType)4U)
#define PwmChannel_LED3_PWM_EN         ((Pwm_ChannelType)5U)
#define PwmChannel_LED4_PWM_EN         ((Pwm_ChannelType)6U)
#define PwmChannel_LED1_PWM_EN         ((Pwm_ChannelType)7U)
#define PwmChannel_LED5_PWM_EN         ((Pwm_ChannelType)8U)
#define PwmChannel_LED6_PWM_EN         ((Pwm_ChannelType)9U)

/** 
* @brief           Symbolic Names for configured channels - ecuc 2108 compliant.
*/
#define  PwmConf_PwmChannelConfigSet_PwmChannel_FAN4_CONTROL         ((Pwm_ChannelType)0U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_FAN3_CONTROL         ((Pwm_ChannelType)1U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_FAN2_CONTROL         ((Pwm_ChannelType)2U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_FAN1_CONTROL         ((Pwm_ChannelType)3U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED2_PWM_EN         ((Pwm_ChannelType)4U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED3_PWM_EN         ((Pwm_ChannelType)5U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED4_PWM_EN         ((Pwm_ChannelType)6U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED1_PWM_EN         ((Pwm_ChannelType)7U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED5_PWM_EN         ((Pwm_ChannelType)8U)
#define  PwmConf_PwmChannelConfigSet_PwmChannel_LED6_PWM_EN         ((Pwm_ChannelType)9U)
...
@{
*/
#define PWM_EMIOS_0_CH_3_USED
#define PWM_EMIOS_0_CH_4_USED
#define PWM_EMIOS_0_CH_5_USED
#define PWM_EMIOS_0_CH_6_USED
#define PWM_EMIOS_1_CH_0_USED
#define PWM_EMIOS_1_CH_1_USED
#define PWM_EMIOS_1_CH_2_USED
#define PWM_EMIOS_1_CH_3_USED
#define PWM_EMIOS_1_CH_5_USED
...
#define PWM_EMIOS_HW_CHANNELS_MAX_U8    (10U)
...
#define PWM_INIT_CONFIG_PB_DEFINES  extern CONST(Pwm_ConfigType, PWM_CONST) PwmChannelConfigSet_0;
