...
/* @violates @ref Pwm_IPW_Types_H_REF_1 Identifier exceeds 31 chars. */
#define PWM_IPW_TYPES_AR_RELEASE_MINOR_VERSION          0
/* @violates @ref Pwm_IPW_Types_H_REF_1 Identifier exceeds 31 chars. */
#define PWM_IPW_TYPES_AR_RELEASE_REVISION_VERSION       3
...
*                                      FILE VERSION CHECKS
==================================================================================================*/
/* Check if included Pwm_eMios_Types.h header file has same vendor */
#if (PWM_IPW_TYPES_VENDOR_ID != PWM_TYPES_VENDOR_ID)
    #error "Pwm_Ipw_Types.h and Pwm_Types.h have different vendor ids"
#endif

/* Check if included Pwm_eMios_Types.h header file has same AUTOSAR version */
...
/* Check if included Pwm_eMios_Types.h header file has same software version */
