...
/**
* @brief            API service ID of Pwm_SwResetCounter function
* @details          Parameters used when raising an error/exception
*/
#define PWM_RESETCOUNTER_ID      (0x30U)

/**
* @brief            API service ID of Pwm_MaskOutputs function
* @details          Parameters used when raising an error/exception
*/
#define PWM_MASKOUTPUT_ID      (0x31U)

/**
* @brief            API service ID of Pwm_UnMaskOutputs function
* @details          Parameters used when raising an error/exception
*/
#define PWM_UNMASKOUTPUT_ID      (0x32U)
...
/*
* @violates @ref Pwm_H_REF_1 Precautions shall be taken in order to prevent the contents of a 
...
#endif
#if (PWM_DIABLE_TRIGEER_API == STD_ON)
...
FUNC(void, PWM_CODE) Pwm_ResetCounter
(
