...
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
#define PWM_IPW_NOTIF_AR_RELEASE_MINOR_VERSION        0
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
#define PWM_IPW_NOTIF_AR_RELEASE_REVISION_VERSION     3
...
/* Function for notifications of eMios channels implemented through macro */
/*
...
#define Pwm_Ipw_GetHwChannelIndex(Channel) Pwm_GetIpChannelIndex((Pwm_ChannelType)(Channel))

/* Function for reporting PeriodValue error implemented through macro */
    ...
    */
    /* @violates @ref Pwm_IPW_Notif_H_REF_4 Function like macro. */
    #define Pwm_Ipw_ReportPeriodValueError() Pwm_ReportPeriodValueError()
#endif /* (PWM_PARAM_CHECK == STD_ON) && (PWM_SET_PERIOD_AND_DUTY_API == STD_ON) */

/* Function for notifications of FlexPwm channels implemented through macro */
/*
* @violates @ref Pwm_IPW_Notif_H_REF_2 A function should be used in preference to a 
* function-like  macro.
*/
/* @violates @ref Pwm_IPW_Notif_H_REF_3 Identifier exceeds 31 chars. */
/* @violates @ref Pwm_IPW_Notif_H_REF_4 Function like macro. */
#define Pwm_Ipw_eMiosChannelNotification(Channel) Pwm_Notification((Pwm_ChannelType)(Channel))
