...
#define ADC_AR_RELEASE_MINOR_VERSION_TYPES          0
/** @violates @ref Adc_Types_h_REF_3 MISRA-C:2004 Rule 1.4: 31 character significance */
#define ADC_AR_RELEASE_REVISION_VERSION_TYPES       3
...
typedef uint8 AdcGroupActionType;         /**< @brief Type of action: normal conversion, self test for open circuit or self test for short circuit */
