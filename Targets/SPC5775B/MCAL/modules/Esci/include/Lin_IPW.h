...
* AUTOSAR imposes the specification of the sections in which certain parts of
* the driver must be placed.
*
...
#define LIN_AR_RELEASE_MINOR_VERSION_IPW     0
#define LIN_AR_RELEASE_REVISION_VERSION_IPW  3
