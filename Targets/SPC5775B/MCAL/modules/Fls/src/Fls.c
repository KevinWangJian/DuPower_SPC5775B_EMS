...
*/
#if(FLS_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
#include "Dem.h"
#endif
...
static CONST(Fls_Flash_SectorInfoType, FLS_CONST) Fls_Flash_aSectorList0[FLASH_SECTOR_COUNT]=
{
    ...
    {   /* FLS_CODE_ARRAY_0_PART_8_LG22 */
        ...
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00D80000,
        FLASH_LGBS_LGSL22_U32,
        FLASH_LGBL_LGLK22_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_8_LG23 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00DC0000,
        FLASH_LGBS_LGSL23_U32,
        FLASH_LGBL_LGLK23_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG24 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00E00000,
        FLASH_LGBS_LGSL24_U32,
        FLASH_LGBL_LGLK24_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG25 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00E40000,
        FLASH_LGBS_LGSL25_U32,
        FLASH_LGBL_LGLK25_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG26 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00E80000,
        FLASH_LGBS_LGSL26_U32,
        FLASH_LGBL_LGLK26_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG27 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00EC0000,
        FLASH_LGBS_LGSL27_U32,
        FLASH_LGBL_LGLK27_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG28 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00F00000,
        FLASH_LGBS_LGSL28_U32,
        FLASH_LGBL_LGLK28_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG29 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        */
        (volatile uint32*)0x00F40000,
        FLASH_LGBS_LGSL29_U32,
        FLASH_LGBL_LGLK29_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG30 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        ...
        */
        ...
        FLASH_LGBS_LGSL30_U32,
        FLASH_LGBL_LGLK30_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    },
    {   /* FLS_CODE_ARRAY_0_PART_9_LG31 */
        /*
        * @violates @ref fls_c_REF_41 Conversions shall not be
        * performed between a pointer to a function and any type other than an integral type
        * @violates @ref fls_c_REF_8 Conversions shall not be
        ...
        */
        ...
        FLASH_LGBS_LGSL31_U32,
        FLASH_LGBL_LGLK31_U32,
        FLASH_SEL2_ADDR32,
        FLASH_LOCK2_ADDR32,
        (boolean)TRUE
    }
...
#define FLASH_DATA_FLASH_EXISTS  (STD_OFF)
...
static FUNC( boolean, FLS_CODE ) Fls_Flash_FinishHVOperation( void )
{
    ...
    */
    ...
    {
        bRetVal = (VAR(boolean, FLS_VAR))TRUE; 
    }
    else
    {
        bRetVal = (VAR(boolean, FLS_VAR))FALSE;
    }
                ...
                */ 
                if(0U == REG_BIT_GET32(FLASH_MCR_ADDR32,FLASH_MCR_PSUS_U32))
                {
                    ...
                    else
                    {
                        ...
                        #if (FLS_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
                        if ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_WriteFailedCfg.state)
                        {
                            Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_WriteFailedCfg.id, DEM_EVENT_STATUS_FAILED);
                        }
                        #endif
                ...
                */ 
                if(0U == REG_BIT_GET32(FLASH_MCR_ADDR32,FLASH_MCR_ESUS_U32))
                {
                    ...
                    else
                    {
                        ...
                        #if (FLS_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
                        if ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_EraseFailedCfg.state)
                        {
                            Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_EraseFailedCfg.id, DEM_EVENT_STATUS_FAILED);
                        }
                        #endif
        ...
        if((0U != (u32McrValue & FLASH_MCR_ERS_U32)) || (0U != (u32McrValue & FLASH_MCR_PGM_U32)))
        {
           /* manage abort possible pending normal erase/program operation */  
            ...
            else
            {
                ...
                if( (0U != (u32McrValue & FLASH_MCR_ERS_U32)) && ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_EraseFailedCfg.state))
                {
                    Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_EraseFailedCfg.id, DEM_EVENT_STATUS_FAILED);
                }
                if( (0U != (u32McrValue & FLASH_MCR_PGM_U32)) && ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_WriteFailedCfg.state))
                {
                    Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_WriteFailedCfg.id, DEM_EVENT_STATUS_FAILED);
                }
                #endif
...
)
{
    ...
    {
        #if (FLS_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
        if ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_ReadFailedCfg.state)
        {
            Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_ReadFailedCfg.id, DEM_EVENT_STATUS_FAILED);
        }
        #endif
...
)
{
    ...
    {
        #if (FLS_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
        if ((VAR(boolean, FLS_VAR))TRUE == Fls_pConfigPtr->Fls_E_CompareFailedCfg.state)
        {
            Dem_ReportErrorStatus((VAR(Dem_EventIdType, AUTOMATIC))Fls_pConfigPtr->Fls_E_CompareFailedCfg.id, DEM_EVENT_STATUS_FAILED);
        }
        #endif
    }
...
( P2CONST( Fls_ConfigType, AUTOMATIC, FLS_APPL_CONST ) pConfigPtr )
{
    ...
    else
    {
        ...
        if (NULL_PTR == pConfigPtr)
        {
            Fls_pConfigPtr = &Fls_ConfigSetPC;
        }
        else
