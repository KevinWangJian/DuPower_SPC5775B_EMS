...
* @brief CAN memory and pointer classes.
*/
#define CAN_43_MCAN_CODE
#define CAN_43_MCAN_CONST
#define CAN_43_MCAN_APPL_DATA
#define CAN_43_MCAN_APPL_CONST
#define CAN_43_MCAN_APPL_CODE
#define CAN_43_MCAN_CALLOUT_CODE
#define CAN_43_MCAN_VAR_NOINIT
#define CAN_43_MCAN_VAR_POWER_ON_INIT
#define CAN_43_MCAN_VAR_FAST
#define CAN_43_MCAN_VAR
/**@}*/
