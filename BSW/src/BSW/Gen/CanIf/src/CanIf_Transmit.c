                                               ...
                                               )
{
    ...
    //annotation by ykj
    if((TxPduConfig_Temp->ControllerRefId==CANIF_Can_Network_CANNODE_5)||(TxPduConfig_Temp->ControllerRefId==CANIF_Can_Network_CANNODE_6))
    {
    	DeviceMode_Temp	= CANIF_CS_STARTED;
        ...
        #endif
    {
        ...
        {
            /*Call Can_Write()*/
        	if(TxPduConfig_Temp->ControllerRefId==CANIF_Can_Network_CANNODE_5)
        	{
           	CanStatus = Can_43_MCAN_Write(TxPduConfig_Temp->HthRefId, &PduInfo_Write);
        	}
        	else if(TxPduConfig_Temp->ControllerRefId==CANIF_Can_Network_CANNODE_6)
        	{
           	CanStatus = Can_43_MCAN_Write(TxPduConfig_Temp->HthRefId, &PduInfo_Write);
        	}
        	else
