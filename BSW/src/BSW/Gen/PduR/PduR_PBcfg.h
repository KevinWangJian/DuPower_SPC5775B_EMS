...
#if !defined(PduR_RF_SoAdIf_Transmit)
#define PduR_RF_SoAdIf_Transmit    (1)
#endif /* PduR_RF_SoAdIf_Transmit */
...
#if !defined(PduR_RF_IpduM_RxIndication)
#define PduR_RF_IpduM_RxIndication    (1)
#endif /* PduR_RF_IpduM_RxIndication */

#define MAX_NO_OF_UPIF_RXINDICATION_TABLE_ENTRIES 1
