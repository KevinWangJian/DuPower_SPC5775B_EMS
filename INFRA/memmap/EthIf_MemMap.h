...
#elif defined ETHIF_START_SEC_CODE_FAST
    #define  BSW_START_SEC_SPRAM_CODE
	#include "Bsw_MemMap.h"
    #undef ETHIF_START_SEC_CODE_FAST
    #undef MEMMAP_ERROR
#elif defined ETHIF_STOP_SEC_CODE_FAST
    #define  BSW_STOP_SEC_SPRAM_CODE
	#include "Bsw_MemMap.h"
    #undef ETHIF_STOP_SEC_CODE_FAST
    #undef MEMMAP_ERROR
