...
#elif defined ETHSM_START_SEC_CONST_32
    #define BSW_START_SEC_DEFAULT_CONST_32
    #include "Bsw_MemMap.h"
    #undef ETHSM_START_SEC_CONST_32
    #undef MEMMAP_ERROR
#elif defined ETHSM_STOP_SEC_CONST_32
...
#elif defined ETHSM_START_SEC_CODE_FAST
    #define  BSW_START_SEC_SPRAM_CODE
	#include "Bsw_MemMap.h"
    #undef ETHSM_START_SEC_CODE_FAST
    #undef MEMMAP_ERROR
#elif defined ETHSM_STOP_SEC_CODE_FAST
    #define  BSW_STOP_SEC_SPRAM_CODE
	#include "Bsw_MemMap.h"
    #undef ETHSM_STOP_SEC_CODE_FAST
    #undef MEMMAP_ERROR
