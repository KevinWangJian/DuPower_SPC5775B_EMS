...
#if defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_1_Channel)
   /* Do nothing for this and all elif clauses below (rte_sws_2751) */
#elif defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_2_Channel)
#elif defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_3_Channel)
#elif defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_4_Channel)
#elif defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_5_Channel)
#elif defined(RTE_RUNNABLEAPI_BSWSE_MainFunction_ComMChannel_Can_Network_6_Channel)
#else
