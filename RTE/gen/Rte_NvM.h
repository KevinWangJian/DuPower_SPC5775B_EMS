...
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_DiagDataBlock1_Finished_JobFinished(VAR(uint8, AUTOMATIC) ServiceId,
                                                                                VAR(NvM_RequestResultType, AUTOMATIC) JobResult);
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_EOLDataBlock_Finished_JobFinished(VAR(uint8, AUTOMATIC) ServiceId,
                                                                              VAR(NvM_RequestResultType, AUTOMATIC) JobResult);
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_NVDataBlock1_Finished_JobFinished(VAR(uint8, AUTOMATIC) ServiceId,
                                                                              VAR(NvM_RequestResultType, AUTOMATIC) JobResult);
#define RTE_STOP_SEC_CODE
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
#if defined(RTE_PRV_ALL_API) || defined(RTE_RUNNABLEAPI_MainFunction)
#define Rte_Call_DiagDataBlock1_Finished_JobFinished Rte_Call_NvM_DiagDataBlock1_Finished_JobFinished /* enableTakeAddress */
#endif
#if defined(RTE_PRV_ALL_API) || defined(RTE_RUNNABLEAPI_MainFunction)
#define Rte_Call_EOLDataBlock_Finished_JobFinished Rte_Call_NvM_EOLDataBlock_Finished_JobFinished /* enableTakeAddress */
#endif
#if defined(RTE_PRV_ALL_API) || defined(RTE_RUNNABLEAPI_MainFunction)
#define Rte_Call_NVDataBlock1_Finished_JobFinished Rte_Call_NvM_NVDataBlock1_Finished_JobFinished /* enableTakeAddress */
#endif
